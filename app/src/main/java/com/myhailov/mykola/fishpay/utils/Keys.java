...
public class Keys {
    ...
    public static final String CODE_OTP = "code_otp";
    ...
    public static final String CHARITY_ANON = "charity_anon";
    public static final String CHARITY_CREATE = "charity_create";
