...
public interface ApiInterface {
    ...
    // 1) registration
    @GET("api/user/checkMobile/{phoneNumber}")
    // check is there users with this phone number exist
    ...
    @FormUrlEncoded
    @POST("api/user/registration/checkOtp")
        // check code from sms
    ...
    @FormUrlEncoded
    @POST("admin/passwordRecovery/checkOtp")
        // check code from sms
    ...
    @FormUrlEncoded
    @POST("admin/passwordRecovery/{userId}")
        // set new password
    ...
    // 3)delete account
    @GET("api/removeAcc/reasons")
    // list of account reasons
...
//                                            @Part("securityCode") RequestBody securityCode);
    ...
    @Multipart
    @POST("api/charity/{charityId}/attemptpay")
    ...
    @Multipart
    @POST("api/charity/{charityId}/auditpay")
    Call<BaseResponse<Object>> auditPayCharity(@Header("Authorization") String token,
                                               @Field("returnUpdated") String returnUpdated,
                                               @Field("is_anonymous") String isAnonymous,
                                               @Path("charityId") String charityId,
                                               @Field("fpt") String fpt,
                                               @Field("id") String id);

    @FormUrlEncoded
    @POST("api/charity/{charityId}/sendlookup")
    Call<BaseResponse<String>> sendLookupCharity(@Header("Authorization") String token,
                                                 @Field("returnUpdated") String returnUpdated,
                                                 @Field("is_anonymous") String isAnonymous,
                                                 @Path("charityId") String charityId,
                                                 @Field("fpt") String fpt,
    ...
    @Multipart
    @POST("api/charity/{id}/uploadPhoto")
